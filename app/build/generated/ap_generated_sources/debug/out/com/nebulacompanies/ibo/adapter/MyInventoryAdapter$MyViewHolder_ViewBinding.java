...
public class MyInventoryAdapter$MyViewHolder_ViewBinding implements Unbinder {
  private MyInventoryAdapter.MyViewHolder target;

  @UiThread
  public MyInventoryAdapter$MyViewHolder_ViewBinding(MyInventoryAdapter.MyViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MyInventoryAdapter.MyViewHolder target = this.target;
