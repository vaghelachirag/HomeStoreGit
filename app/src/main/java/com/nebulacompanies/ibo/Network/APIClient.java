...
import static com.nebulacompanies.ibo.util.Config.TESTING_API_SHOPPY;
...
public class APIClient {
   ...
   // private static SessionVacation sessionVacation;
    ...
    public static Retrofit getShoppyClient(final Context mContext) {
