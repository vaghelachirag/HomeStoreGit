...
public class SellProductsActivity extends AppCompatActivity implements OnProductAdded {
    ...
    AutoResizeTextView txtSubTitle;
    ImageView imgBack;
    ...
    ImageView imgEdit, imgSearch, imgSearchBack;//imgClose
                ...
                case 2:
                    ...
                    if (TextUtils.isEmpty(custName) || TextUtils.isEmpty(custNumber)) {
                        ...
                        if (custNumber.length() != 10) {
                            ...
                            iboid = "";
                            iboname = "";
                            txtSubTitle.setText("Customer: " + custName + " (" + custNumber + ")");
                    ...
                    if (response.isSuccessful()) {
                        if (response.code() == 200) {
                            if (response.body().getStatusCode() == Constants.REQUEST_STATUS_CODE_SUCCESS) {
                                ...
                                txtSubTitle.setText("IBO : " + iboid + " (" + iboname + ")");
                                custNumber = "";
                                custName = "";
                                showUser = 1;
                                dialogDetails.dismiss();
    ...
    private void initUI() {
        ...
        txtSubTitle = findViewById(R.id.toolbar_title2);
        ...
        imgSearchBack = findViewById(R.id.img_search_edit);
        layTitle = findViewById(R.id.lay_title);
        layCart = findViewById(R.id.lay_my_cart);

        txtSubTitle.setText("Click here to add buyer info");
        ...
        layTitle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (TextUtils.isEmpty(iboid)) {
                    // showCustomer();
