...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.MyViewHolder> {
    ...
    public SearchAdapter(Context context, ArrayList<SearchModelDetails> userArrayList, CustomItemClickListener customItemClickListener) {
    ...
    public void onBindViewHolder(MyViewHolder viewHolder, int position) {
        ...
        String ibo = String.valueOf(filteredUserList.get(position).getSearchSalePrice());
        String homestore = String.valueOf(filteredUserList.get(position).getHomeStorePrice());
        viewHolder.tvOfferPriceValue.setText(homestore);
        viewHolder.tvOriginalPriceValue.setText(ibo);
        viewHolder.tvMrp.setText(mrp);
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private MyTextViewEcom tvOriginalPriceValue, tvMrp;
        ...
        public MyViewHolder(View view) {
            ...
            tvOfferPriceValue = view.findViewById(R.id.tv_offer_price_value);
            tvOriginalPriceValue = view.findViewById(R.id.tv_original_price_value);
