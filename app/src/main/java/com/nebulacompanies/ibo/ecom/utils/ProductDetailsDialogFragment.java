...
public class ProductDetailsDialogFragment extends BottomSheetDialogbackFragment implements
   ...
   // ProgressDialog mProgressDialog;
    ...
    //Location
    // LogCat tag
    private final String TAG1 = "ProductDetailsDialogFragment";
    ...
    String name, city, pincode, alldata,address,state,addressType,userId;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        pinCodeAdapter = new PinCodeAdapter( addressDataList, getActivity(), new PinCodeAdapter.ItemListener() {
            ...
            @Override
            public void onItemEditClick(AddressModel addressDataList) {
