...
public class ProductDecsDetailsDialogFragment extends BottomSheetDialogFragment
    ...
    public final static String TAG = "ActionBottomDialog";
   // private final static int PLAY_SERVICES_REQUEST = 1000;
/*    private final static int REQUEST_CHECK_SETTINGS = 2000;
    private final static String TAG1 = "ProductDecsFragment";*/
   ...
   // String addressEditCallBack, addressMobile;
    ...
    String name, city, pincode, alldata, address, state, addressType,
            cityFacilityValue, cityFacility, allPickUpData, namePickUp, currentLocation, userId;
  ...
  //  private GoogleApiClient mGoogleApiClient;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mAPIInterfaceShoppy = APIClient.getShoppyClient(getActivity()).create(APIInterface.class);
        ...
        rbOnline =  view.findViewById(R.id.rd1);
        rbPickUp =  view.findViewById(R.id.rd2);
        rbAhmd =  view.findViewById(R.id.rd_ahmd);
        rbHyd =  view.findViewById(R.id.rd_hyd);
        rbChennai =  view.findViewById(R.id.rd_chennai);
        tvcity =  view.findViewById(R.id.tv_city);
        horizontalScrollView =  view.findViewById(R.id.horizontal_address);
        horizontalPickUp =  view.findViewById(R.id.horizontal_pick_up);
        txtOR = view.findViewById(R.id.textor);
        rvAddress =  view.findViewById(R.id.rv_address_list);
        rvAddress.setHasFixedSize(true);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getActivity(), LinearLayoutManager.HORIZONTAL, false);
        rvAddress.setLayoutManager(mLayoutManager);


        rvPickUpAddress = view.findViewById(R.id.rv_pickup_list);
        ...
        pinCodeAdapter = new PinCodeAdapter(addressDataList, getActivity(), new PinCodeAdapter.ItemListener() {
            ...
            public void onItemClick(AddressModel addressDataList) {
                if (addressDataList != null) {
                   ...
                   /* try {
                    ...
                    ((MyCartActivity) getActivity()).setSelectedLocation(addressType, allCityID, alldata, isAddressType, cityFacilityValue, isPincodeServicable, addressDataList.isPincodeAvailableHS());
                    //}
                    dismiss();
                }
            }
            ...
            @Override
            public void onItemEditClick(AddressModel data) {
                if (addressDataList != null) {
                   /* cityID = addressDataList.getID();
                    name = addressDataList.getFullName();
                    city = addressDataList.getAddressCity();
                   ...
                   *//* try {
                    ...
                    //}
                    dismiss();*/
                    Intent addressEdit = new Intent(getActivity(), EditAddressAccountActivity.class);
        ...
        pickUpAddressAdapter = new PickUpAddressAdapter(pickUpAddressModels, getActivity(), new PickUpAddressAdapter.ItemListener() {
            ...
            public void onItemClick(PickUpAddressModel addressDataList) {
                if (addressDataList != null) {
                    ...
                    ((MyCartActivity) getActivity()).setSelectedLocation(addressType, allCityIDPickUp, allPickUpData, isAddressType, cityFacilityValue, true, true);
        ...
        tvMyAccountAddresses =  view.findViewById(R.id.tv_my_account_addresses);

        getAddressList();


        lnPincode =  view.findViewById(R.id.ln_pincode);
        lnAvailability =  view.findViewById(R.id.ln_availability);
        tvEnterPincode =  view.findViewById(R.id.tv_enter_pincode);
        imgPincodeBack =  view.findViewById(R.id.img_pincode_back);
        tvDetectLocation =  view.findViewById(R.id.tv_detect_location);

        tvMyAccountAddresses.setOnClickListener(v -> {
            Intent dash = new Intent(getActivity(), AddAddressAcountNewActivity.class);
            startActivity(dash);
        });
       ...
       /* if (checkPlayServices()) {
        ...
        if (session.getShoppyid() == 0) {
            //ghj
            rbPickUp.setVisibility(View.GONE);
            txtOR.setVisibility(View.GONE);
            rbOnline.performClick();
        }else {
            rbPickUp.setVisibility(View.VISIBLE);
    ...
    public void onClick(View view) {
        ...
        //MyBoldTextViewEcom myBoldTextViewEcom =  view;
    ...
    private void getPickUpAddressList(String cityId) {
        if (Utils.isNetworkAvailable(getActivity())) {
            mProgressDialog.setVisibility(View.VISIBLE);
            Call<PickUpAddressData> wsCallingEvents = mAPIInterfaceShoppy.getPickUpListEcom(cityId);
...
/*
                            ...
                            if (response.body().getResponse().getStatusCode() == REQUEST_STATUS_CODE_NO_RECORDS) {
                                ...
                                pickUpAddressModels.clear();
                                pickUpAddressModels.addAll(response.body().getResponse().getData());
                                Log.d("AddressListGETIN", "AddressListGETIN: " + response.body().getResponse().getMessage());
