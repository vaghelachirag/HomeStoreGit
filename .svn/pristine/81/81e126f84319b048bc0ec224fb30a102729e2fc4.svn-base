...
boolean showEdit;
    ...
    public PinCodeAdapter(ArrayList<AddressModel> addressDataList, Context context, ItemListener mListener,boolean showEdit) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.imgEdit.setVisibility(showEdit?View.VISIBLE:View.GONE);
        ...
        holder.imgEdit.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mListener != null) {
                    mListener.onItemEditClick( addressDataList.get( position ) );
                }
            }
        } );
    }
...
ImageView imgEdit;
    ...
    public interface ItemListener {
        ...
        void onItemEditClick(AddressModel addressDataList);
    }
}
