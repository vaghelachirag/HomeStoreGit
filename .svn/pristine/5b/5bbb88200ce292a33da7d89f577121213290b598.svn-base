...
import com.nebulacompanies.ibo.model.CityList;
...
public class EditAddressAccountActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    Session session;
    String deviceId, selectedState, stateName, selectedcity, userId;
    ...
    void initOnClick() {
        ...
        btnDeliver.setOnClickListener(view -> {
            if (tvAddAddressName.getText().toString().length() == 0 ||
                ...
                editAddressDetails( tvAddAddressMobile.getText().toString(),
                        tvAddAddressName.getText().toString(),
                        ...
                        tvAddAddressPincode.getText().toString(), spinnerAddressType.getSelectedItem().toString(),userId, addressID);
                ...
                public void onResponse(Call<CityDetails> call, Response<CityDetails> response) {
                    if (response.isSuccessful()) {
                        if (response.body().getResponse().getStatusCode() == REQUEST_STATUS_CODE_SUCCESS) {
                            ...
                            for (CityList cityList : response.body().getResponse().getData()) {
                                String city = cityList.getCityName();
    ...
    private void editAddressDetails( final String mobile,  final String fullNames, final  String addressLine1, final  String addressLine2,
                                     final  String landmark, final String city, final String state, final String pinCode,
                                     final String addressType,  final String userId,  final Integer id) {
        if (Utils.isNetworkAvailable(getApplicationContext())) {
        ...
        mProgressDialog1.setContentView(R.layout.progressdialog_ecom);*/
            ...
            Call<AddAddressDetail> wsCallingAddAddress = mAPiInterfaceShoppy.editAddressDetails(userId,mobile,
                    fullNames, addressLine1,
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (response.code() == 200) {
                            ...
                            if (response.body().getResponse().getStatusCode() == REQUEST_STATUS_CODE_SUCCESS) {
                                ...
                                Log.d("addressNameSave", "address:: "+address);

                                String addressNameSave = fullNames + ", " + address + ", " + city + ", " + state + "- " + pinCode;
                                Log.d("addressNameSave", addressNameSave);
                                ...
                                editorpreferencesAddressType.putBoolean(PrefUtils.prefAddresstype, false);
                                ...
                                editorpreferencesAddressCityID.putInt(PrefUtils.prefPrefcityid, id);
                                ...
                                editorFacility.putString(PrefUtils.prefFacility, "nebula");
