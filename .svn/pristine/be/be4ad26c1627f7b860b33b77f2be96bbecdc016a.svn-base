  ...
  /*  public static final int ID_AAVAAS_CHANGODER_COMPLEX = 7;
   ...
   /* public static final int HOLIDAYS_THAILAND = 8;
    ...
    public static class WEB_SERVICES {
        ...
        public static final String WS_GET_VERSION = "/api/Config/GetHomeStoreVersion";
      ...
      /*  public static final String WS_GET_HOLIDAY_ACHIEVER = "/API/HolidayIncome/AchieverDetails";
        ...
        public static final String WS_STATE_LIST = "/api/Config/GetStateList";
        public static final String WS_CITY_LIST = "/api/Config/GetCityList";

        //Testing
        public static final String WS_GET_TOKEN = "/api/Login";
...
*/
        ...
        public static final String WS_LOGIN_VALIDATE_KEY = "/API/Profile/GetProfileForShoppe";
 ...
 */
        ...
        public static final String WS_GET_INVOICE = "/api/Order/GetInvoice";
        ...
        public static final String WS_GET_ORDER_LIST = "/api/Order/GetOrderList";
        public static final String WS_GET_OFFER_LIST = "/API/EComCouponCode/EcomOfferList";
        public static final String ADD_TO_CART_POST = "/api/Cart/AddToCart";
        public static final String ADD_TO_CART_POST_NOLOGIN = "/API/ECom/AddToCartWithoutUser";
        public static final String ADD_TO_CONFIRM = "/api/Sales/PlaceOrderV2";
        ...
        public static final String DELETE_FROM_CART_POST = "/api/Cart/RemoveFromCart";
        public static final String DELETE_REC_FROM_CART_POST = "/api/Cart/RemoveAnyProductV2";
        public static final String UPDATE_FROM_CART_POST = "/api/Cart/UpdateVariant";
        ...
        public static final String MY_CART_LIST_ECOM = "/api/Cart/GetCartItemsListV2";
        public static final String MY_CART_LIST_RACK_ECOM = "/api/Cart/GetPromoData";

        public static final String MY_CART_LIST_ECOM_WO_LOGIN = "/API/ECom/GetCartItemsListWithoutUser";

        public static final String MY_CART_WALLET_AMOUNT = "/api/EWallet/GetIBOWalletBalance";
        public static final String MY_BAL_WALLET = "/api/EWallet/GetIBOWalletBalanceWithTempEwallet";


        public static final String MY_FREE_PRODUCT_LIST_ECOM = "/API/ECom/GetPromoData";
        public static final String MY_CART_REVIEW_LIST_ECOM = "/api/Cart/GetOutOfStock";
        public static final String MY_CART_REMOVE_LIST_ECOM = "/api/Cart/RemoveOutOfStock";
        ...
        public static final String ADD_VARIANT = "/api/Cart/GetProductVariants";
        public static final String WS_MINIMUM_PV = "/API/ECom/GetMinimumPVForIBOPrice";
        public static final String WS_DELETE_CART = "/api/cart/cartdelete";
        public static final String WS_PAYTM_CART = "/api/PaytmWebhook/WebhookPaytmAndroid";

        public static final String WS_DELETE_EWALLET = "/api/EWallet/PostTempEwalletReverseAmount";
...
*/
        ...
        public static final String MY_CARD_DETAILS_ECOMV2 = "/api/ShoppyPayment/GetPaymentGatewayContentpaytm";
        public static final String MY_CART_TOTAL_COUNT_LIST_ECOM = "/api/Cart/GetCartSumOfQty";
        public static final String MY_INVENTORY = "/api/Cart/GetCartInventory";
        public static final String MY_SALESLIST = "/api/Sales/GetSalesList";
        public static final String MY_IBONAME = "/api/UserInfo/GetIBOFullName";

        public static final String MY_PROFILE_ECOM = "/API/ECom/Me";
        public static final String TRACK_ORDER_ECOM = "/api/Order/GetOrderDetailWithTrackOrder";
        ...
        public static final String ADDRESS_LIST_ECOM = "/api/Address/GetAddresses";
        public static final String PICK_UP_LIST_ECOM = "/api/Address/GetPickUpAddressByCity";

        //public static final String ADDRESS_LIST_ECOM = "/API/ECom/GetAddressesByDeviceId";
        public static final String ADD_ADDRESS_DETAILS = "/api/Address/AddAddress";
        public static final String SUCCESS_UPI = "API/EcomPaymentUPI/OnSuccessPaymentCallUPI";
        public static final String UPDATE_ADDRESS_DETAILS = "/api/Address/UpdateAddress";
        public static final String DELETE_ADDRESS_DETAILS = "/api/Address/DeleteAddress";
        ...
        public static final String WS_CATEGORY = "/API/ECom/ProductListByCategoryWithPaginationForHS";
        ...
        public static final String ID_CARD = "/Api/NebProDashboard/IBOIdCard";
        ...
        //SHoppy
        public static final String WS_GET_SHOPPY_LIST = "/api/ShoppyPackages/GetShoppyPackagesList";
        public static final String WS_GET_TERMS_CONDITION = "/api/Policies/GetPoliciesList";
        public static final String WS_GET_MY_SHOPPY = "/api/ShoppyPackages/GetHomeRePurchaseUser";
    ...
    public static class WEB_SERVICES_PARAM {
      ...
      /*  public static final String KEY_IFSC_CODE = "IFSCCode";
        ...
        public static final String KEY_DEVICE_IDD = "deviceId";
        ...
        public static final String KEY_MODEL_two = "txnid";
        public static final String KEY_USER_SHOPPYID = "Userid";
        ...
        public static final String KEY_CUSTNUMBER = "customerphone";
        public static final String KEY_IBO_KEY_ID_Pickup = "pickupid";
        public static final String KEY_IBO_IDD = "iboid";
        public static final String KEY_TOTAL = "totalprice";
        //  public static final String KEY_MODEL ="modeldetail";

        public static final String KEY_REGISTER_USER_ID = "userId";
        public static final String KEY_REGISTER_OLD_ID = "oldid";
        public static final String KEY_REGISTER_NEW_ID = "newid";
        ...
        public static final String KEY_USERNAME_SHOPPY = "userName";
        ...
        //SHOPPY
        public static final String KEY_SHOPPY_DEVICE_ID_ECOM = "deviceid";
        public static final String KEY_SHOPPY_USER_ID = "userid";
        public static final String KEY_SHOPPY_PRODUCT_ID = "productid";
        public static final String KEY_SHOPPY_QUANTITY = "quantity";
        public static final String KEY_SHOPPY_CART_FLAG = "sign";
        public static final String KEY_SHOPPY_USER_ID_cap = "UserID";
        public static final String KEY_SHOPPY_PACKAGE_ID = "ShoppyPackageID";

        public static final String KEY_SHOPPY_PACK_ID = "shoppypackageid";
        public static final String KEY_IBO_ID_SHOPPE = "ibokeyid";
        public static final String KEY_IBO_ID_SHOPPEID = "ShoppePackageId";
        public static final String KEY_IBO_ID_ISMANDATORY = "ismandatory";
