...
public class Session {
    ...
    public static final String shoppyID = "shoppyID";
    public static final String shoppyNAME = "shoppyname";
    public static final String shoppyAMT = "shoppyAmount";
    public static final String tempshoppyID = "tempshoppyID";
    ...
    private final static String IBO_SHOPPY_ID="IBO_SHOPPYUSER_ID";
    ...
    public void setShoppyUserID(String userID) {
        editor.putString(IBO_SHOPPY_ID, userID);
        editor.commit();
    }

    public String getShoppyUserID() {
        String login_id = sharedpreferences.getString(IBO_SHOPPY_ID, "");
        return login_id;
    }
    ...
    public void setShoppyid(int shoppyId) {
        Log.d("setshopp"," :: "+shoppyId);
        editor.putInt(shoppyID, shoppyId);
        editor.commit();
    }

    public int getShoppyid() {
        int login = sharedpreferences.getInt(shoppyID, 0);
        Log.d("getshopp"," :: "+login);

        return login;
    }

    public void setRepurchaseamt(int shoppyAmt) {
        editor.putInt(repurchaseAmt, shoppyAmt);
        editor.commit();
    }

    public int getRepurchaseAmt() {
        int login = sharedpreferences.getInt(repurchaseAmt, 0);
        return login;
    }

    public void setShoppyName(String shoppyName) {
        editor.putString(shoppyNAME, shoppyName);
        editor.commit();
    }

    public String getShoppyName() {
        return sharedpreferences.getString(shoppyNAME, "");
    }
    public void setShoppyAmt(int shoppyamt) {
        editor.putInt(shoppyAMT, shoppyamt);
        editor.commit();
    }

    public int getShoppyamt() {
        return sharedpreferences.getInt(shoppyAMT, 0);
    }
    public void setTempShoppyid(int shoppyId) {
        editor.putInt(tempshoppyID, shoppyId);
        editor.commit();
    }

    public int getTempShoppyid() {
        int login = sharedpreferences.getInt(tempshoppyID, 0);
        return login;
    }
